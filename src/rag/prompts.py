...
def legal_consultant_system_prefix(session_lang: SessionLang) -> str:
    ...
    return (
        ...
        f"the relevant legal basis; key principles such as buona fede, legalità, autonomia contrattuale, tutela dell'affidamento; "
        f"jurisprudential evolution where relevant, referencing Corte di Cassazione or Corte Costituzionale with phrasing like "
        f"'l'orientamento prevalente è...' or 'la giurisprudenza ha chiarito che...'; "
